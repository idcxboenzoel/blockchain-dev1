$(function(){
    ...
    $("#btnSubmitPa").click(function(e){
        ...
        if(totalw !== max_total) {
            alertWarning('Warning', 'Total Weight must be '+max_total)
            return false;
        }     
    ...
    $("#btnApprove").click(function (e) {
        ...
        let name = $('#name_employee').val();
        let pa_id = $('#pa_id').val();
        let alertHtml = alertConfirm({'nik':nik, 'name' : name, 'pa_id' : pa_id}, 'approve');
              ...
              $('.modal_alert .yes').on('click', function() {
                  ...
                  $.ajax({
                    ...
                    if(data.status !== 201) {
                      ...
                      setTimeout(function () {
                        window.location.href  = '/Approval/PerformanceAppraisal'
                      }, 2000);
                    },
                    failed: function (xhr, textStatus, errorThrown) {
                      alertError("Failed", xhr.message);
    ...
    $("#btnRevise").click(function (e) {
        ...
        let alertHtml = alertConfirm({'nik':nik, 'name' : name, 'pa_id' : pa_id}, 'sendback');
        ...
        Swal.fire({
            ...
            $('.modal_alert .yes').on('click', function() {
                ...
                success: function (data) {
                    ...
                    html = "<p>Send Back Performance Appraisal Setting is succuesfully.</p>";
                    // html += "<p>See you soon at MMSGI Gala Dinner 2023!</p>"
    ...
    function setTotalKpiScore()
    {
        ...
        $("#total_kpi_score input").val(total.toFixed(2));
        $("#total_kpi_score span").html(total.toFixed(2));
  ...
  function alertConfirm(data, type) { 
    ...
    if(type === 'sendback') {
        ...
        formname = 'formRevise'
        action = '/Api/PerformanceAppraisal/revise'
        show_desc2 = 'hide'
    }else {
...
title_desc1 = 'Are you sure you want approve this document'
        ...
        action = '/Api/PerformanceAppraisal/approve'
        show_desc1_sub = 'hide'
            ...
            <div class="modal_alert">
                ...
                <div class="ITEMS">
                    ...
                    <form class="div notes ${show_notes}" id="${formname}" action="${action}">
                      ...
                      <input type="hidden" name="pa_id" class="pa_id" value="${data['pa_id']}" />
