$(function(){
    ...
    var table_data = $('#table_data').DataTable({
        ...
        "columns": [
            ...
            { "data": "fullname","width":"25%",
                render: function(data, type, row, meta) { 
                    var dt1 = '<a style="color:blue;" href="/Approval/DetailPerformanceAppraisal/'+row.nik+'">'+row.fullname+'</a><br>';
    ...
    var table_data = $('#table_data_admin').DataTable({
        // Gw tambahain style ini mam start
        createdRow: function ( row, data, index ) {
            $(row).addClass('selected')
         } ,
        ...
        "columns": [
            ...
            { "data": "fullname","width":"25%",
                render: function(data, type, row, meta) { 
                    var dt1 = '<a style="color:blue;" href="/Assessment/DetailPerformanceAppraisal/'+row.nik+'">'+row.fullname+'</a><br>';
                    // var dt2 = '<small style="color:gray;">'+row.nik+'</small>';
