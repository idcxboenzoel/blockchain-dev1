$(function(){
    ...
    const validationFormQuantitative = () => {
        ...
        $('.weight_percent').each(function(k) {
            ...
            if(val === '' || val === null) {
                error = 1;
                message2 = "Weight Percent Cant be empty"
                $(this).css('border', '#EE3232 solid 1px')
            }else{
                success = 1;
                $(this).css('border', '#DBDBDB solid 1px')
        ...
        $('.formula').each(function(k) {
            ...
            if(val === '' || val === null) {
                error = 1;
                message4 = "Formula Cant be empty"
                $(this).css('border', '#EE3232 solid 1px')
            }else{
                success = 1;
                $(this).css('border', '#DBDBDB solid 1px')
        ...
        $('.achievement').each(function(k) {
            ...
            if(val === '' || val === null) {
                error = 1;
                message5 = "Achievement Cant be empty"
                $(this).css('border', '#EE3232 solid 1px')
            }else{
                success = 1;
                $(this).css('border', '#DBDBDB solid 1px')
        ...
        $('.score_qualitative').each(function(k) {
            ...
            if(val === '' || val === null) {
                error = 1;
                message6 = "Score Qualitative Cant be empty"
                $(this).css('border', '#EE3232 solid 1px')
            }else{
                success = 1;
                $(this).css('border', '#DBDBDB solid 1px')
        ...
        $('.justification').each(function(k) {
            ...
            if(val === '' || val === null) {
                error = 1;
                message7 = "Justification Cant be empty"
                $(this).css('border', '#EE3232 solid 1px')
            }else{
                success = 1;
                $(this).css('border', '#DBDBDB solid 1px')
        ...
        $('.evidence_name').each(function(k) {
            ...
            if(val === '' || val === null) {
                ...
                // alertError('Failed', "Evidence file cant be empty");
                message8 = "Evidence file cant be empty"
