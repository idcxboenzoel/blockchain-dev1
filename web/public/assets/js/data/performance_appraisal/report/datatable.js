$(function(){
    ...
    var table_data = $('#table_data').DataTable({
        ...
        // "ordering": false,
        "ajax":{
            "url": "/Api/Report/pa?login_as=approval",
            "type": "get",
            "dataType": 'json',
            "data": {
        ...
        "columns": [
            ...
            { "data": "fullname","width":"35%",
                render: function(data, type, row, meta) { 
                    var dt1 = '<a style="color:blue;" href="/Report/PerformanceAppraisal/Detail/'+row.nik+'">'+row.fullname+'</a><br>';
                    var dt2 = ``
            ...
            { "data": "supervisors","width":"25%",'className':'text-center',
                render: function(data, type, row, meta) { 
                    ...
                    let logs = row.pa !== null ? row.pa.log_approvals : [];
                    if(logs.length > 0) {
            ...
            { "data": "pa","width":"25%",'className':'text-center',
                render: function(data, type, row, meta) { 
    ...
    var table_data_admin = $('#table_data_admin').DataTable({
        ...
        // "ordering": false,
        "ajax":{
            "url": "/Api/Report/pa?login_as=admin",
            "type": "get",
            "dataType": 'json',
            "data": {
                REQUEST_CODE: function() { return '' },
        ...
        "columns": [
            ...
            { "data": "pa","width":"35%",'className':'text-center',
                render: function(data, type, row, meta) { 
                    let status = data !== null ? data.status_approval : 0;
                    let type_status = ['Draft','Pending Approval','Pending Approval','Approved','Send Back','Rejected'];
